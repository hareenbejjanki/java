...
public class LoginHeaderPanel extends ImageBackgroundPanel {
    ...
    private void init() {
        ...
        Label header1 = new Label(uiOtherProperties.getProperty(UIConstants.Other.LOGIN_HEADER1_TEXT), PropertyUtil.getFont(uiStylesProperties,
        ...
        Label header2 = new Label(uiOtherProperties.getProperty(UIConstants.Other.LOGIN_HEADER2_TEXT), PropertyUtil.getFont(uiStylesProperties,
